...
<div data-dev={dev} class="svg-pattern h-full min-h-screen bg-slate-300">
	<div class="flex-y-center mx-auto max-w-screen-md py-12 text-slate-950">
		<div class="border-nested mt-8 mb-32">
